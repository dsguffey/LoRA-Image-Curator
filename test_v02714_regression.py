...
def test_current_release_chains_include_v02714() -> None:
    ...
    assert '"test_v02714_regression.py"' in _source("tools/run_regressions.py")
    build = _source("tools/build_release.py")
    assert '"test_v02714_regression.py"' in build
    assert '"test_v02714_gui.py"' in build
    assert '"test_v02717_gui.py"' in _source("test_golden_build.py")
    assert (
