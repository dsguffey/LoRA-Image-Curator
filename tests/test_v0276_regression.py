...
def test_v0276_release_remains_in_maintained_history() -> None:
    ...
    assert '"tests/test_v0276_regression.py"' in regressions
    assert '"tests/test_v0276_regression.py"' in build
    assert '"tests/test_v0276_gui.py"' in build
...
def test_golden_runner_owns_complete_release_gate() -> None:
    ...
    assert '"tests/test_v0275_regression.py"' in regressions
    assert '"tests/test_v0276_regression.py"' in regressions
    assert '"tests/test_golden_build.py"' in build
    assert '"tests/test_v0276_gui.py"' in build
