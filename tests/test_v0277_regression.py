...
def test_v0277_release_remains_in_maintained_history() -> None:
    ...
    assert '"tests/test_v0277_regression.py"' in regressions
    assert '"tests/test_v0277_regression.py"' in build
    assert '"tests/test_v0277_gui.py"' in build
...
def test_golden_runner_uses_bounded_compilation_and_current_gui() -> None:
    ...
    assert f'"tests/{current_gui}"' in runner
    assert '"tests/test_v0277_regression.py"' in regressions
